...
p_xiaoyu = ['avjnjmiuninst', 'bgdcvn', 'bqpb', 'bqtp', 'bqyptp', 'instrument', 'jafreqfrq', 'melancholy', 'qwaszx', 'sfrhhgt2345Uninst', 'sjrpghuninst', 'spoiler', 'srzy2345setting', 'sysssnew', 'wfreqhfure', 'xymn', 'xypbuninst', 'xytipsxhVV12', 'xytipsxytt', 'xytpopoth', 'yXjUcuninst', 'yb32345setting']
p_kuaizip = ['Eg_NNIfiu', 'Kuaipb', 'Selenarctos', 'VLscDaseKX', 'YVyVcPZzs', 'alkanePanda', 'kuaiyaminixktt', 'kuaiyatipsrytx', 'kuaiyatpopxktt', 'kuaiyatpopxxrl', 'kuaiyatuop', 'kuauninst', 'kwGOkLeLvH', 'kzyptp', 'lakesi', 'parmiuninst', 'parpbuninst', 'partnuninst', 'polarbear', 'qbylwl', 'restless', 'wbdyl']
...
p_qjpdf = ['23455SafeLock', 'Jskjdi', 'Nsewuninst', 'Spiuninst', 'ZFCEa', 'dqsPl', 'mBErTV', 'mxLK', 'mxqjPO', 'peimg', 'sWXluJ', 'update', 'xmuninst']
...
p_haotu = ['E240.TMP', 'Hyzus', 'Lolzzcxx', 'Thkuninst', 'Update', 'Weather', 'amkfiopg', 'baizhe', 'gajfgk', 'htkktp', 'htkktpoprytx', 'jgklfdgu', 'mkouninst', 'mqtyrp', 'wewouninst', 'xwView', 'zztpopkk']
