...
path_2 = 'C:/Users/Administrator/AppData/'

xiaoyu = {
    'package': path_1 + 'xiaoyu_v3.3.0.7_lv_1.exe -wjm',
    'updc': path_2 + 'Roaming/xiaoyu/upgrade.exe',
...
kuaizip = {
    ...
    'updc': path_2 + 'Roaming/快压/X86/KuaiZip.exe',
...
kantu = {
    ...
    'updc': path_2 + 'PhotoViewer/Update.exe',
...
heinote = {
    ...
    'updc': path_2 + 'Roaming/Heinote/upgrade.exe',
...
finder = {
    ...
    'updc': path_2 + '/Local/finder/cc.exe',
...
browser = {
    ...
    'updc': path_2 + '7654Browser/UpdateChecker.exe',
...
haotu = {
    ...
    'updc': path_2 + 'Roaming/haotukankan/Viewuc.exe',
...
lszip = {
    ...
    'updc': path_2 + '雷神压缩/ThorUpdateChecker.exe',
...
jcbz = {
    ...
    'updc': path_2 + '鲸彩壁纸/UpdateCheck.exe',
...
qjpdf = {
    ...
    'updc': path_2 + 'Roaming/qingjiepdf/qjUpdateChecker.exe',
